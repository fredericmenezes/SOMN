...
class A2C(OnPolicyAlgorithm):
    ...
    def train(self) -> None:
        ...
        wandb.log({'entropy_loss': entropy_loss.item(), 'timesteps': self.num_timesteps})
        wandb.log({'policy_loss': policy_loss.item(), 'timesteps': self.num_timesteps})
        wandb.log({'value_loss': value_loss.item(), 'timesteps': self.num_timesteps})

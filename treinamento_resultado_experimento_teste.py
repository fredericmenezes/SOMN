...
if __name__ == "__main__":
    ...
    with open("./config_result_teste.yaml") as file:
            config = yaml.load(file, Loader=yaml.FullLoader)

    best_mean_reward, num_best_ppo_lstm = train_and_select_best("test_histogramas_ppo_lstm",
                                                            RecurrentPPO, 
                                                            "ppo_lstm", 
                                                            config["ppo_lstm"], 
                                                            n_evaluations, 
                                                            total_timesteps)
    # best_mean_reward, num_best_dqn = train_and_select_best("test_histogramas_dqn",
    #                                                     DQN, 
    #                                                     "dqn", 
    #                                                     config["dqn"], 
    #                                                     n_evaluations, 
